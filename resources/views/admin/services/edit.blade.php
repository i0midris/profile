...
@section('subtitle', __('admin.update_service_details'))
    ...
    <div class="max-w-5xl">
        ...
        <form method="POST" action="{{ route('admin.services.update', $service) }}" enctype="multipart/form-data"
            ...
            <div class="admin-card p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="title_en" name="title_en" value="{{ old('title_en', $service->title_en) }}" required
                            class="form-input" placeholder="{{ __('admin.placeholder_service_title') }}">
                        @error('title_en')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea id="description_en" name="description_en" rows="4" required class="form-input"
                            placeholder="{{ __('admin.placeholder_service_description') }}">{{ old('description_en', $service->description_en) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="description_ar" name="description_ar" rows="4" required
                            class="form-input">{{ old('description_ar', $service->description_ar) }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="icon" name="icon" value="{{ old('icon', $service->icon) }}"
                            class="form-input" placeholder="{{ __('admin.placeholder_icon_name') }}">
                    </div>
                ...
                @php
                    $featuresEn = old('features_en', $service->features_en ?? ['']);
                    $featuresAr = old('features_ar', $service->features_ar ?? ['']);
                @endphp
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
            ...
            <div class="flex items-center gap-4">
                <button type="submit"
                    class="px-6 py-3 rounded-lg btn-primary text-white font-medium">{{ __('admin.update_service') }}</button>
